...
<footer class="bg-white text-gray-600 py-12 border-t border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-5">
                ...
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-3 no-underline">
                    <div class="bg-gray-100 p-1.5 rounded-lg shadow-md">
                        <img src="<?php echo e(asset('/logo-footer.PNG')); ?>" alt="Logo" class="h-32 w-38">
                    </div>
                </a>
        ...
        <div
            ...
            <p class="text-center md:text-left">&copy; <?php echo e(date('Y')); ?> Zubilant Bali Tours. All rights reserved. <span class="hidden md:inline">|</span> <span class="block md:inline mt-1 md:mt-0">Created by <a href="https://wiklycode.vercel.app/" target="_blank" rel="noopener noreferrer" class="text-orange-500 hover:text-orange-600 transition-colors duration-200 font-semibold">WiklyCode.dev</a></span></p>
            <div class="mt-4 md:mt-0 flex gap-5">
                <a href="<?php echo e(route('terms')); ?>" class="hover:text-orange-500 transition-colors duration-200">Terms &amp; Conditions</a>
                <a href="#" class="hover:text-orange-500 transition-colors duration-200">Privacy Policy</a>
                <a href="<?php echo e(route('help')); ?>" class="hover:text-orange-500 transition-colors duration-200">Help Center</a>
            </div>
        </div>

    </div>
</footer><?php /**PATH /home/dwiki/Documents/website/zubilantbalitours/resources/views/partials/front-footer.blade.php ENDPATH**/ ?>